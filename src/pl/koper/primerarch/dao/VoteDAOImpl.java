...
public class VoteDAOImpl implements VoteDAO {
    ...
    private static final String CREATE_VOTE = "INSERT INTO vote(primer_id, user_id, date, type)" +
            " VALUES(:primer_id, :user_id, :date, :type);";

    private static final String READ_VOTE = "SELECT vote_id, primer_id, user_id, date, type " +
            "FROM vote WHERE vote_id = :vote_id;";

    private static final String READ_VOTE_BY_DISCOVERY_USE_IDS = "SELECT vote_id, primer_id, user_id, date, type " +
            "FROM vote WHERE user_id = :user_id AND primer_id = :primer_id;";
    ...
    public Vote create(Vote vote) {
        ...
        paramMap.put("primer_id", voteCopy.getPrimerid());
    ...
    @Override
    public Vote getVoteByUserIdPrimerId(long userId, long primerId) {
        Map<String, Object> paramMap = new HashMap<>();
        paramMap.put("user_id", userId);
        paramMap.put("primer_id", primerId);
        SqlParameterSource paramSource = new MapSqlParameterSource(paramMap);
        Vote vote = null;
        try {
    ...
    private class VoteRowMapper implements RowMapper<Vote> {
        ...
        public Vote mapRow(ResultSet resultSet, int i) throws SQLException {
            ...
            vote.setPrimerid(resultSet.getLong("primer_id"));
